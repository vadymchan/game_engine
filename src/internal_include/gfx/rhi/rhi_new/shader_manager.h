...
// TODO: remove
inline EShaderAccessStageFlag convertToShaderAccessFlag(ShaderStageFlag stage) {
  switch (stage) {
    ...
    case ShaderStageFlag::TessellationControl:
      return EShaderAccessStageFlag::TESSELLATION_CONTROL;
    case ShaderStageFlag::TessellationEvaluation:
      return EShaderAccessStageFlag::TESSELLATION_EVALUATION;
    case ShaderStageFlag::RaytracingRaygen:
      return EShaderAccessStageFlag::RAYTRACING_RAYGEN;
    case ShaderStageFlag::RaytracingMiss:
      return EShaderAccessStageFlag::RAYTRACING_MISS;
    case ShaderStageFlag::RaytracingClosesthit:
      return EShaderAccessStageFlag::RAYTRACING_CLOSESTHIT;
    case ShaderStageFlag::RaytracingAnyhit:
      return EShaderAccessStageFlag::RAYTRACING_ANYHIT;
    default:
...
class ShaderManager {
  ...
  std::unique_ptr<Shader> createShaderObject(const std::filesystem::path& path, const std::string& entryPoint) {
    ...
    auto compiledShader
        = DxcUtil::s_get().compileHlslFile(path, convertToShaderAccessFlag(stage), wEntryPoint, backend);
