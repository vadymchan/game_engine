...
static const std::unordered_map<TextureFilter, VkSamplerMipmapMode> mipmapModeMapping = {
  { TextureFilter::Nearest,              VK_SAMPLER_MIPMAP_MODE_NEAREST },
  ...
  { TextureFilter::NearestMipmapLinear,  VK_SAMPLER_MIPMAP_MODE_LINEAR  },
...
VkPipelineStageFlagBits g_getPipelineStageMaskVk(PipelineStageMask type) {
  switch (type) {
    case PipelineStageMask::None:
      return VK_PIPELINE_STAGE_NONE;
    case PipelineStageMask::TopOfPipeBit:
      return VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT;
    case PipelineStageMask::DrawIndirectBit:
      return VK_PIPELINE_STAGE_DRAW_INDIRECT_BIT;
    case PipelineStageMask::VertexInputBit:
      return VK_PIPELINE_STAGE_VERTEX_INPUT_BIT;
    case PipelineStageMask::VertexShaderBit:
      return VK_PIPELINE_STAGE_VERTEX_SHADER_BIT;
    case PipelineStageMask::TessellationControlShaderBit:
      return VK_PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BIT;
    case PipelineStageMask::TessellationEvaluationShaderBit:
      return VK_PIPELINE_STAGE_TESSELLATION_EVALUATION_SHADER_BIT;
    case PipelineStageMask::GeometryShaderBit:
      return VK_PIPELINE_STAGE_GEOMETRY_SHADER_BIT;
    case PipelineStageMask::FragmentShaderBit:
      return VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT;
    case PipelineStageMask::EarlyFragmentTestsBit:
      return VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT;
    case PipelineStageMask::LateFragmentTestsBit:
      return VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT;
    case PipelineStageMask::ColorAttachmentOutputBit:
      return VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT;
    case PipelineStageMask::ComputeShaderBit:
      return VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT;
    case PipelineStageMask::TransferBit:
      return VK_PIPELINE_STAGE_TRANSFER_BIT;
    case PipelineStageMask::BottomOfPipeBit:
      return VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT;
    case PipelineStageMask::HostBit:
      return VK_PIPELINE_STAGE_HOST_BIT;
    case PipelineStageMask::AllGraphicsBit:
      return VK_PIPELINE_STAGE_ALL_GRAPHICS_BIT;
    case PipelineStageMask::AllCommandsBit:
...
VkMemoryPropertyFlagBits g_getMemoryPropertyFlagBitsVk(VulkanMemoryBits type) {
  switch (type) {
    case VulkanMemoryBits::DeviceLocal:
      return VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT;
    case VulkanMemoryBits::HostVisible:
      return VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT;
    case VulkanMemoryBits::HostCoherent:
      return VK_MEMORY_PROPERTY_HOST_COHERENT_BIT;
    case VulkanMemoryBits::HostCached:
      return VK_MEMORY_PROPERTY_HOST_CACHED_BIT;
    case VulkanMemoryBits::LazilyAllocated:
      return VK_MEMORY_PROPERTY_LAZILY_ALLOCATED_BIT;
    case VulkanMemoryBits::Protected:
      return VK_MEMORY_PROPERTY_PROTECTED_BIT;
    case VulkanMemoryBits::DeviceCoherentAmd:
      return VK_MEMORY_PROPERTY_DEVICE_COHERENT_BIT_AMD;
    case VulkanMemoryBits::DeviceUncachedAmd:
      return VK_MEMORY_PROPERTY_DEVICE_UNCACHED_BIT_AMD;
    case VulkanMemoryBits::RdmaCapableNv:
      return VK_MEMORY_PROPERTY_RDMA_CAPABLE_BIT_NV;
    case VulkanMemoryBits::FlagBitsMaxEnum:
...
VkBufferUsageFlagBits g_getBufferBitsVk(VulkanBufferBits type) {
  switch (type) {
    case VulkanBufferBits::TransferSrc:
      return VK_BUFFER_USAGE_TRANSFER_SRC_BIT;
    case VulkanBufferBits::TransferDst:
      return VK_BUFFER_USAGE_TRANSFER_DST_BIT;
    case VulkanBufferBits::UniformTexelBuffer:
      return VK_BUFFER_USAGE_UNIFORM_TEXEL_BUFFER_BIT;
    case VulkanBufferBits::StorageTexelBuffer:
      return VK_BUFFER_USAGE_STORAGE_TEXEL_BUFFER_BIT;
    case VulkanBufferBits::UniformBuffer:
      return VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT;
    case VulkanBufferBits::StorageBuffer:
      return VK_BUFFER_USAGE_STORAGE_BUFFER_BIT;
    case VulkanBufferBits::IndexBuffer:
      return VK_BUFFER_USAGE_INDEX_BUFFER_BIT;
    case VulkanBufferBits::VertexBuffer:
      return VK_BUFFER_USAGE_VERTEX_BUFFER_BIT;
    case VulkanBufferBits::IndirectBuffer:
      return VK_BUFFER_USAGE_INDIRECT_BUFFER_BIT;
    case VulkanBufferBits::ShaderDeviceAddress:
      return VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT;
    case VulkanBufferBits::TransformFeedbackBuffer:
      return VK_BUFFER_USAGE_TRANSFORM_FEEDBACK_BUFFER_BIT_EXT;
    case VulkanBufferBits::TransformFeedbackCounterBuffer:
      return VK_BUFFER_USAGE_TRANSFORM_FEEDBACK_COUNTER_BUFFER_BIT_EXT;
    case VulkanBufferBits::ConditionalRendering:
      return VK_BUFFER_USAGE_CONDITIONAL_RENDERING_BIT_EXT;
    case VulkanBufferBits::AccelerationStructureBuildInputReadOnly:
      return VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT_KHR;
    case VulkanBufferBits::AccelerationStructureStorage:
      return VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR;
    case VulkanBufferBits::ShaderBindingTable:
...
static const std::unordered_map<VkFilter, TextureFilter> filterReverseMapping = reverseMap(filterMapping);
static const std::unordered_map<VkSamplerAddressMode, TextureAddressMode> addressModeReverseMapping
    = reverseMap(addressModeMapping);
static const std::unordered_map<VkSamplerMipmapMode, TextureFilter> mipmapModeReverseMapping
...
static const std::unordered_map<VkPrimitiveTopology, PrimitiveType> topologyReverseMapping
    = reverseMap(topologyMapping);
static const std::unordered_map<VkVertexInputRate, VertexInputRate> inputRateReverseMapping
    = reverseMap(inputRateMapping);
static const std::unordered_map<VkPolygonMode, PolygonMode> polygonModeReverseMapping = reverseMap(polygonModeMapping);
static const std::unordered_map<VkFrontFace, FrontFace>     frontFaceReverseMapping   = reverseMap(frontFaceMapping);
static const std::unordered_map<VkStencilOp, StencilOp>     stencilOpReverseMapping   = reverseMap(stencilOpMapping);
static const std::unordered_map<VkCompareOp, CompareOp>     compareOpReverseMapping   = reverseMap(compareOpMapping);
static const std::unordered_map<VkBlendFactor, BlendFactor> blendFactorReverseMapping = reverseMap(blendFactorMapping);
static const std::unordered_map<VkBlendOp, BlendOp>         blendOpReverseMapping     = reverseMap(blendOpMapping);
static const std::unordered_map<VkImageLayout, ResourceLayout> imageLayoutReverseMapping
...
TextureFilter g_getTextureFilterTypeVk(VkFilter filter) {
  return getEnumMapping(filterReverseMapping, filter, TextureFilter::Count);
}
...
TextureFilter g_getTextureMipmapModeVk(VkSamplerMipmapMode mipmapMode) {
  return getEnumMapping(mipmapModeReverseMapping, mipmapMode, TextureFilter::Count);
}
...
PrimitiveType g_getPrimitiveTopologyVk(VkPrimitiveTopology primitiveTopology) {
  return getEnumMapping(topologyReverseMapping, primitiveTopology, PrimitiveType::Count);
}
...
VertexInputRate g_getVertexInputRateVk(VkVertexInputRate inputRate) {
  return getEnumMapping(inputRateReverseMapping, inputRate, VertexInputRate::Count);
}
...
FrontFace g_getFrontFaceVk(VkFrontFace frontFace) {
  return getEnumMapping(frontFaceReverseMapping, frontFace, FrontFace::Count);
}
...
BlendFactor g_getBlendFactorVk(VkBlendFactor blendFactor) {
  return getEnumMapping(blendFactorReverseMapping, blendFactor, BlendFactor::Count);
}
