...
class IRenderModelLoader {
  ...
  // Optionally returns CPU-side geometry model
  // TODO: check that std::optional works. if not, use std::shared_ptr<Model>*
  // instead
  virtual std::shared_ptr<RenderModel> loadRenderModel(
