...
utils::ErrorCode DX11RenderAPI::InitializeImpl(HWND hwnd) {
...
void DX11RenderAPI::DrawTriangleImpl() {
    ...
    const float clearColor[] = {0.2f, 0.3f, 0.3f, 1f};
...
if (FAILED(hr)) {
    throw std::runtime_error("Failed to create DirectX 11 device and context.");
}
}
