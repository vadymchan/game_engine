...
void Game::setup() {
  ...
  //  camera.width  = m_window_->getSize().width() != 0 ? m_window_->getSize().width() : 1;
  //  camera.height = m_window_->getSize().height() != 0 ? m_window_->getSize().height() : 1;
  ...
  // teapot
  //{
  //  auto      teapot = registry.create();
  //  Transform teapotTransform;
  //  teapotTransform.translation = math::Vector3Df(0.0f, 0.0f, -7.0f);
  //  teapotTransform.scale       = math::Vector3Df(1.0f, 1.0f, 1.0f);
  //  teapotTransform.rotation    = math::Vector3Df(0.0f, 0.0f, 0.0f);
  ...
  //  registry.emplace<Movement>(teapot);
  //}
