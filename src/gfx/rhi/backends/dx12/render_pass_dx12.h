...
class RenderPassDx12 : public RenderPass {
  ...
  ResourceLayout getFinalColorAttachmentLayout(uint32_t index) const;

  ResourceLayout getFinalDepthStencilLayout() const { return m_depthStencilFinalLayout; }
  ...
  std::vector<ResourceLayout> m_colorFinalLayouts;
  ResourceLayout              m_depthStencilFinalLayout = ResourceLayout::ShaderReadOnly;
