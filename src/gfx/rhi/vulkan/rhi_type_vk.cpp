...
ETextureFilter g_getVulkanTextureFilterType(VkFilter filter) {
    return getEnumMapping(filterReverseMapping, filter, ETextureFilter::NEAREST);
}
...
static const std::unordered_map<VkSamplerAddressMode, ETextureAddressMode> addressModeReverseMapping = reverseMap(addressModeMapping);
...
static const std::unordered_map<VkSamplerMipmapMode, ETextureFilter> mipmapModeReverseMapping = reverseMap(mipmapModeMapping);
...
static const std::unordered_map<VkPrimitiveTopology, EPrimitiveType> topologyReverseMapping = reverseMap(topologyMapping);
...
EPrimitiveType g_getVulkanPrimitiveTopology(VkPrimitiveTopology primitiveTopology) {
    return getEnumMapping(topologyReverseMapping, primitiveTopology, EPrimitiveType::POINTS);
}
...
static const std::unordered_map<VkVertexInputRate, EVertexInputRate> inputRateReverseMapping = reverseMap(inputRateMapping);
...
EVertexInputRate g_getVulkanVertexInputRate(VkVertexInputRate inputRate) {
    return getEnumMapping(inputRateReverseMapping, inputRate, EVertexInputRate::VERTEX);
}
...
EFrontFace g_getVulkanFrontFace(VkFrontFace frontFace) {
    return getEnumMapping(frontFaceReverseMapping, frontFace, EFrontFace::CW);
}
...
EBlendFactor g_getVulkanBlendFactor(VkBlendFactor blendFactor) {
    return getEnumMapping(blendFactorReverseMapping, blendFactor, EBlendFactor::ZERO);
}
...
static const std::unordered_map<VkImageLayout, EResourceLayout> imageLayoutReverseMapping = reverseMap(imageLayoutMapping);
...
EResourceLayout g_getVulkanImageLayout(VkImageLayout resourceLayout) {
    return getEnumMapping(imageLayoutReverseMapping, resourceLayout, EResourceLayout::UNDEFINED);
}
...
static const std::unordered_map<VkDynamicState, EPipelineDynamicState> dynamicStateReverseMapping = reverseMap(dynamicStateMapping);
...
EPipelineDynamicState g_getVulkanPipelineDynamicState(VkDynamicState dynamicState) {
    return getEnumMapping(dynamicStateReverseMapping, dynamicState, EPipelineDynamicState::VIEWPORT);
}
