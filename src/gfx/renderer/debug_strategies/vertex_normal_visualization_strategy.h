...
/**
 * Renders vertex normals as lines
 */
class VertexNormalVisualizationStrategy : public DebugDrawStrategy {
  public:
  VertexNormalVisualizationStrategy() = default;
  ...
  rhi::Shader* m_geometryShader = nullptr;
